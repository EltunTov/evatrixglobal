      ...
      <section className="evx-shell">
        <div className="evx-panel">
          ...
          <p className="evx-hero-text">
            Hidden operational layer for member monitoring, role checks, access overview.
          </p>
                  ...
                  <tbody>
                    {stats.recentUsers.map((u) => (
                      <tr key={u.id}>
                        ...
                        <td style={{ padding: "12px 8px", color: "#96a8c5" }}>{u.createdAt}</td>
                        <td style={{ padding: "12px 8px", color: "#96a8c5" }}>{u.lastLoginAt}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
